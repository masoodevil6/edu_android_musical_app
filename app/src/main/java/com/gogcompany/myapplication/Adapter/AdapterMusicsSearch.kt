...
class AdapterMusicsSearch(
    private val context:          Context ,
    private val list:             ArrayList<Musics> ,
    private val fragmentManager:  FragmentManager
    ) : RecyclerView.Adapter<AdapterMusicsSearch.Holder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AdapterMusicsSearch.Holder {
        var layout = LayoutInflater.from(context).inflate(R.layout.item_music_search , parent , false);
        return Holder(layout);
    }

    override fun onBindViewHolder(holder: AdapterMusicsSearch.Holder, position: Int) {
    ...
    class Holder(itemView : View):RecyclerView.ViewHolder(itemView){
        var image : CircleImageView = itemView.findViewById(R.id.element_id_recycler_music_search_image_music);
        var artist : TextView = itemView.findViewById(R.id.element_id_recycler_music_search_txt_name_artist);
        var music : TextView = itemView.findViewById(R.id.element_id_recycler_music_search_txt_name_music);
    }
}