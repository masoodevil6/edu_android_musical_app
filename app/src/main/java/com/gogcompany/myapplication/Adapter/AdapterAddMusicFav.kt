...
class AdapterAddMusicFav(
    private val context: Context ,
    private val list: List<MusicAddFav>,
    private val fragmentManager: FragmentManager
) : RecyclerView.Adapter<AdapterAddMusicFav.Holder>(){
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AdapterAddMusicFav.Holder {
        val layout = LayoutInflater.from(context).inflate(R.layout.item_add_music_fav , parent , false);
        return Holder(layout)
    }

    override fun onBindViewHolder(holder: AdapterAddMusicFav.Holder, position: Int) {
